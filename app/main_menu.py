...
def run_main_menu():
    ...
    inventory_button = tk.Button(window, text="Inventory Object Page", command=lambda:inventory.open_inventory_page)
    equipment_button = tk.Button(window, text="Equipment Parts Page", command=lambda:equipment.open_equipment_page)
